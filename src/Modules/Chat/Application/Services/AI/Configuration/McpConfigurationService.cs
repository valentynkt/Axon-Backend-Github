...
namespace Axon.Modules.Chat.Application.Services.AI.Configuration;
...
public sealed class McpConfigurationService : IMcpConfigurationService
{
    ...
    public Result<IReadOnlyCollection<McpServerConfig>> LoadEnabledConfigurations()
    {
        ...
        return result.IsSuccess 
            ? Result<IReadOnlyCollection<McpServerConfig>>.Success(result.Value)
            : Result<IReadOnlyCollection<McpServerConfig>>.Failure(result.Error);
    }
