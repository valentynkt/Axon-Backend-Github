...
public sealed class WalletRepository : EfWriteRepository<Wallet, WalletId>, IWalletRepository
{
    private readonly IWriteUnitOfWork _unitOfWork;

    public WalletRepository(IdentityDbContext context, IWriteUnitOfWork unitOfWork) : base(context)
    {
