...
public sealed class AxonPrincipalRepository : EfWriteRepository<AxonPrincipal, AxonId>, IAxonPrincipalRepository
{
    private readonly IWriteUnitOfWork _unitOfWork;

    public AxonPrincipalRepository(IdentityDbContext context, IWriteUnitOfWork unitOfWork) : base(context)
    {
    ...
    {
        // Use direct LINQ for now - this method looks for principals with specific credentials
        // This is a complex join query that might be better optimized manually
        return await DbSet
