...
public static class PostgresConfiguration
{
        ...
        where TContext : DbContext, IDbContext
    {
        ...
        builder.Services.AddPostgresDbContext<TContext>(builder.Configuration);
    ...
    /// <summary>
    /// Add repository-level caching using the new decorator-based approach
    /// This properly separates read and write concerns while maintaining caching functionality
    /// </summary>
    private static IServiceCollection AddRepositoryCaching(this IServiceCollection services)
    {
        services.AddMemoryCache();
        
        // Use the new decorator-based caching approach
        // This will be applied to all registered IReadRepository and IWriteRepository implementations
        return services.AddRepositoryCaching();
    }
}
...
public class PerOperationTransactionHandler : ITransactionBehaviorHandler
{
    ...
    public PerOperationTransactionHandler(IWriteUnitOfWork unitOfWork)
    {
    ...
    where TContext : DbContext, IDbContext
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            _logger.LogInformation("PostgreSQL health check cancelled");
            return HealthCheckResult.Unhealthy("PostgreSQL health check was cancelled", ex);
        }
    }
}