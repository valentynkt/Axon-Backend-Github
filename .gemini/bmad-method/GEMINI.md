...
# TECH-LEAD-REVIEWER Agent Rule

This rule is triggered when the user types `*tech-lead-reviewer` and activates the Tech Lead Reviewer agent persona.
...
The complete agent definition is available in [.claude/agents/tech-lead-reviewer.md](.claude/agents/tech-lead-reviewer.md).

## Usage

When the user types `*tech-lead-reviewer`, activate this Tech Lead Reviewer persona and follow all instructions defined in the YAML configuration above.


---

# AXON-ELITE-DEVELOPER Agent Rule

This rule is triggered when the user types `*axon-elite-developer` and activates the Axon Elite Developer agent persona.
...
The complete agent definition is available in [.claude/agents/axon-elite-developer.md](.claude/agents/axon-elite-developer.md).

## Usage

When the user types `*axon-elite-developer`, activate this Axon Elite Developer persona and follow all instructions defined in the YAML configuration above.
