...
public class ResourceManagementRule : ArchitectureRuleBase
{
    ...
    private static bool IsApplicationType(Type type)
    {
        return !type.IsInterface &&
               ...
               // Skip architecture test framework types - they don't need resource management validation
               type.Namespace?.Contains("ArchitectureTests", StringComparison.OrdinalIgnoreCase) != true &&
               // Skip compiler-generated types including async state machines and other synthetic types
               !IsCompilerGeneratedType(type);
    }

    private static bool IsCompilerGeneratedType(Type type)
    {
        // Skip compiler-generated types including top-level program synthetic types and async state machines
        return type.Name.Contains("AutoGenerated", StringComparison.OrdinalIgnoreCase) ||
               ...
               type.Name.Contains("StateMachine", StringComparison.OrdinalIgnoreCase) ||
               type.Name.Contains("d__", StringComparison.OrdinalIgnoreCase) || // Async method state machines
