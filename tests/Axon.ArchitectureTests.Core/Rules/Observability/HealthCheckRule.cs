...
public sealed class HealthCheckRule : ArchitectureRuleBase
{
    ...
    {
        // Skip compiler-generated types including top-level program synthetic types
        return type.Name.Contains("AutoGenerated", StringComparison.OrdinalIgnoreCase) ||
               type.Name.Contains('$') ||
               ...
               type.GetCustomAttributes().Any(attr => 
                   ...
                   attr.GetType().Name.Contains("DebuggerNonUserCode"));
    }
}